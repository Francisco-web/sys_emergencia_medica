<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">SGEM</span>
        </a>
    ...
    <?php
        ...
        if ($auth->tipoUsuario() == 'Recepcionista') {

    ?>
        <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item active">
                <a href="painel_recepcionista.php" class="menu-link">
    ...
    <?php
        ...
        if ($auth->tipoUsuario() == 'Enfermeiro(a)') {
